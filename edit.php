...
if (isset($_GET['message']) && $_GET['message'] ==2) {
	$response = "<p style='color: red;'>Please fill in all Fields</p>";
}?>
...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    if (isset($_POST['product-update-btn'])) {
        ...
        $file_size = $_FILES['productImage']['size']/1024;
       // $file_type = $_FILES['productImage']['type'];
        $imageExt = pathinfo($_FILES['productImage']['name'],PATHINFO_EXTENSION);
        ...
        $newImageName = time().".".$imageExt;
            ...
            move_uploaded_file($file_temp, $destination);
             ...
             $query = mysqli_query($db, "UPDATE products SET product_name='$productName', price='$price', image='$newImageName', category='$category', description='$description', vendor_name='$vendor', type='$type' WHERE id='productId');");
               if ($query) {
               ...
               "<script>setTimeout(()=>{
                ...
                $query = mysqli_query($db, "UPDATE products SET product_name='$productName', price='$price', category='$category', description='$description', vendor_name='$vendor', type='$type' WHERE id='productId');");
               if ($query) {
                $response ="<p style='color:green; font-weight:600;'>product Inserted Successfully</p>".
               "<script>setTimeout(()=>{
                window.location.assign('./products.php');
    ...
    <div class="container">
        ...
        <div class="sub-container">
            <div class="profile-settings">
                <h2>Edit Product</h2>
                <form action="product-update.php" method="post"  autocomplete="off" enctype="multipart/form-data">
                    ...
                    <div class="div-main">
                        <div>
                            ...
                            <br>
                            <input type="text" name="productName" id="productName" value="<?php echo $result['product_name'] ?>">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <br>
                            <input type="file" name="productImage" id="profile-image">   
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <br>
                            <input type="text" name="vendor" id="vendor" value="<?php echo $result['vendor_name'] ?>">
                        </div>
                        <div>
                        ...
                        <button type="submit" name="product-update-btn" class="save">Save Changes</button>
                    </div>
                 </form>
            </div>
        </div>
